 ...
 **********************************************************************************************************************
 */
#define BSWM_TOTAL_NO_OF_ACTIONLIST                         16
...
/* BswMEcuMWakeupSource MRP Type Definition 
 * - Pointer to array containing indexes of associated rules 
 * - Number of rules referring to this MRP
...
typedef struct {
	const uint16 *adrRulesRef_pu16;
	uint16 nrAssociatedRules_u16;
	uint32 dataWakeupSource_u32;
	EcuM_WakeupStatusType dataModeInitValue_u8;
	BswM_ReqProcessing_ten dataReqProcessing_en;
	boolean isModeInitValuePresent_b;
} BswM_Cfg_MRPEcuMWakeUpSrcType_tst;
...
typedef struct {
	...
	BswM_Cfg_MRPEcuMWakeUpSrcType_tst dataEcuMWkpSrc_ast[BSWM_NO_OF_ECUMWKP_SOURCES]; /* EcuM Wakeup Source */
