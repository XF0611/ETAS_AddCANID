...
#define FEE_REQUIRED_FREE_SPACE_BEFORE_SOFT_SR        32776uL  /* FEE_REQUIRED_FREE_SPACE_BEFORE_HARD_SR = Min sector size + 1 = 32768 byte + 1) * 1,5 * 1,0 */
#define FEE_REQUIRED_FREE_SPACE_BEFORE_HARD_SR        32776uL  /* FEE_REQUIRED_FREE_SPACE_BEFORE_HARD_SR = Min sector size + 1 = 32768 byte + 1 * 1,0 */
...
#define FEE_PHYS_SEC_END0    0x00007FFFuL
...
#define FEE_PHYS_SEC_START1  0x00008000uL
#define FEE_PHYS_SEC_END1    0x0000FFFFuL
...
#define FeeConf_FeeBlockConfiguration_NVM_ID_EVMEM_LOC_4                                          0
#define FeeConf_FeeBlockConfiguration_NVM_ID_EVMEM_LOC_5                                          1
#define FeeConf_FeeBlockConfiguration_NvBlock_NvBlockDescriptor_StoreImmediateBlock               2
#define FeeConf_FeeBlockConfiguration_NVM_ID_EVMEM_LOC_7                                          3
#define FeeConf_FeeBlockConfiguration_NVM_ID_EVMEM_LOC_6                                          4
#define FeeConf_FeeBlockConfiguration_NVM_ID_EVMEM_LOC_1                                          5
#define FeeConf_FeeBlockConfiguration_NVM_ID_EVMEM_LOC_0                                          6
#define FeeConf_FeeBlockConfiguration_NVM_ID_EVMEM_LOC_2                                          7
#define FeeConf_FeeBlockConfiguration_NVM_ID_EVMEM_LOC_3                                          8
#define FeeConf_FeeBlockConfiguration_NvBlock_NvBlockDescriptor_StoreCyclicBlock                  9
#define FeeConf_FeeBlockConfiguration_NVM_ID_DEM_GENERIC_NV_DATA                                  10
#define FeeConf_FeeBlockConfiguration_NvMBlock_LogisticData                                       11
#define FeeConf_FeeBlockConfiguration_NVM_ID_EVT_STATUSBYTE                                       12
#define FeeConf_FeeBlockConfiguration_NVM_ID_EVMEM_LOC_9                                          13
#define FeeConf_FeeBlockConfiguration_NVM_ID_EVMEM_LOC_8                                          14
#define FeeConf_FeeBlockConfiguration_NV_ExternalReprogrammingRequestFlagBlock                    15
#define FeeConf_FeeBlockConfiguration_NvMBlockDescriptor_ECUConfiguration                         16
#define FeeConf_FeeBlockConfiguration_NvBlock_NvBlockDescriptor_StoreAtShutdownBlock              17
#define FeeConf_FeeBlockConfiguration_ECUM_CFG_NVM_BLOCK                                          18
