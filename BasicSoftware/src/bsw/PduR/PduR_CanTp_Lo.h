...
#else
#define PduR_iCanTpCopyRxDataID(id)        (PDUR_CANTP_RXIND_BASE[PDUR_CANTP_RXIND_MAP_TAB[(id)]].upId)
#define PduR_iCanTpCopyRxDataFunc(id)      (PduR_upTpCopyRxDataTable[(PDUR_CANTP_RXIND_BASE[PDUR_CANTP_RXIND_MAP_TAB[(id)]].upProvideRxBufID)].PduR_upTpCopyRxDataFunc)

#endif /* PDUR_CONFIG_SINGLE_TPRX */

extern BufReq_ReturnType PduR_dCanTpCopyRxData(PduIdType id,
...
#else
#define PduR_iCanTpStartOfReceptionID(id)        (PDUR_CANTP_RXIND_BASE[PDUR_CANTP_RXIND_MAP_TAB[(id)]].upId)
#define PduR_iCanTpStartOfReceptionFunc(id)      (PduR_upTpStartOfReceptionTable[(PDUR_CANTP_RXIND_BASE[PDUR_CANTP_RXIND_MAP_TAB[(id)]].upStartOfReceptionID)].PduR_upTpStartOfReceptionFunc)
#endif /* PDUR_CONFIG_SINGLE_TPRX */

extern BufReq_ReturnType PduR_dCanTpStartOfReception(PduIdType id,
...
#else
#define PduR_iCanTpRxIndicationID(id)           (PDUR_CANTP_RXIND_BASE[PDUR_CANTP_RXIND_MAP_TAB[(id)]].upId)

#define PduR_iCanTpRxIndicationFunc(id)         (PduR_upTpRxIndicationTable[(PDUR_CANTP_RXIND_BASE[PDUR_CANTP_RXIND_MAP_TAB[(id)]].upRxIndicationID)].PduR_upTpRxIndicationFunc)

#endif /* PDUR_CONFIG_SINGLE_TPRX */

extern void PduR_dCanTpRxIndication(PduIdType id, Std_ReturnType std);
...
#else
#define PduR_iCanTpCopyTxDataID(id)        (PDUR_CANTP_TXCONF_BASE[PDUR_CANTP_TXCONF_MAP_TAB[(id)]].upId)
#define PduR_iCanTpCopyTxDataFunc(id)      (PduR_upTpCopyTxDataTable[(PDUR_CANTP_TXCONF_BASE[PDUR_CANTP_TXCONF_MAP_TAB[(id)]].upProvideTxBufID)].PduR_upTpCopyTxDataFunc)

#endif /* PDUR_CONFIG_SINGLE_TPTX_UP */

extern BufReq_ReturnType PduR_dCanTpCopyTxData(PduIdType id,
...
#else
#define PduR_iCanTpTxConfirmationID(id)         (PDUR_CANTP_TXCONF_BASE[PDUR_CANTP_TXCONF_MAP_TAB[(id)]].upId)

#define PduR_iCanTpTxConfirmationFunc(id)       (PduR_upTpTxConfirmationTable[(PDUR_CANTP_TXCONF_BASE[PDUR_CANTP_TXCONF_MAP_TAB[(id)]].upTxConfirmationID)].PduR_upTpTxConfirmationFunc)

#endif /* PDUR_CONFIG_SINGLE_TPTX_UP */

extern void PduR_dCanTpTxConfirmation(PduIdType id, Std_ReturnType std);
