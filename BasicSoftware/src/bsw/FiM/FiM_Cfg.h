...
#define FIM_CFG_DEM_TRIGGERFIMREPORTS            (FIM_CFG_OFF)
...
#define FIM_CFG_MAXIMUM_LINKS_PER_FID_CALC       (1)

/* configured number of Dem event IDs */
#define FIM_CFG_NUMBEROFDEMEVENTIDS              (77)

/* configured number of Dem component IDs */
#define FIM_CFG_NUMBEROFDEMCOMPONENTIDS          (0)
