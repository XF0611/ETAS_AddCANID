...
#define NVM_CFG_CRC_16_NR_RAM_BLOCKS    (3u)
#define NVM_CFG_CRC_32_NR_RAM_BLOCKS    (0u)
#define NVM_CFG_CRC_NR_RAM_BLOCKS       (3u)
// TRACE[NVM119_Conf]
...
#define NVM_SIZE_STANDARD_JOB_QUEUE (255u)
...
#define NvMConf_NvMBlockDescriptor_NvMBlock_LogisticData (2u)
#define NvMConf_NvMBlockDescriptor_ECUM_CFG_NVM_BLOCK (3u)
#define NvMConf_NvMBlockDescriptor_NVM_ID_DEM_GENERIC_NV_DATA (4u)
#define NvMConf_NvMBlockDescriptor_NVM_ID_EVMEM_LOC_0 (5u)
#define NvMConf_NvMBlockDescriptor_NVM_ID_EVMEM_LOC_1 (6u)
#define NvMConf_NvMBlockDescriptor_NVM_ID_EVMEM_LOC_2 (7u)
#define NvMConf_NvMBlockDescriptor_NVM_ID_EVMEM_LOC_3 (8u)
#define NvMConf_NvMBlockDescriptor_NVM_ID_EVMEM_LOC_4 (9u)
#define NvMConf_NvMBlockDescriptor_NVM_ID_EVMEM_LOC_5 (10u)
#define NvMConf_NvMBlockDescriptor_NVM_ID_EVMEM_LOC_6 (11u)
#define NvMConf_NvMBlockDescriptor_NVM_ID_EVMEM_LOC_7 (12u)
#define NvMConf_NvMBlockDescriptor_NVM_ID_EVMEM_LOC_8 (13u)
#define NvMConf_NvMBlockDescriptor_NVM_ID_EVMEM_LOC_9 (14u)
#define NvMConf_NvMBlockDescriptor_NvMBlockDescriptor_ECUConfiguration (15u)
#define NvMConf_NvMBlockDescriptor_NVM_ID_EVT_STATUSBYTE (16u)
#define NvMConf_NvMBlockDescriptor_NV_ExternalReprogrammingRequestFlagBlock (17u)
#define NvMConf_NvMBlockDescriptor_NvBlock_NvBlockDescriptor_StoreAtShutdownBlock (18u)
#define NvMConf_NvMBlockDescriptor_NvBlock_NvBlockDescriptor_StoreCyclicBlock (19u)
#define NvMConf_NvMBlockDescriptor_NvBlock_NvBlockDescriptor_StoreImmediateBlock (20u)
...
#define NVM_CFG_NV_BLOCK_LENGTH_NV_ExternalReprogrammingRequestFlagBlock (4u)
#define NVM_CFG_NV_BLOCK_LENGTH_NvBlock_NvBlockDescriptor_StoreAtShutdownBlock (96u)
#define NVM_CFG_NV_BLOCK_LENGTH_NvBlock_NvBlockDescriptor_StoreCyclicBlock (1024u)
#define NVM_CFG_NV_BLOCK_LENGTH_NvBlock_NvBlockDescriptor_StoreImmediateBlock (384u)
...
#define NVM_CFG_LAST_USER_BLOCK     (20u)

// TRACE[BSW_SWS_AR4_0_R2_NVRAMManager_Ext-3159]
// Number of all configured blocks
#define NVM_CFG_NR_BLOCKS           (21u)

// Additional internal helper definitions
#define NVM_PRV_NR_BLOCKS_ADMIN   (21u)
#define NVM_PRV_NR_PERSISTENT_IDS (19u)
