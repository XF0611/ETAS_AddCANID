...
// Central MACROs are generated, to make a modification for the erasure options fast.
#define DEM_CFG_ERASE_ALL_CHECK_DATA_SUPPORTED              ((DEM_CFG_ERASE_ALL_DATA_SUPPORTED == DEM_CFG_ERASE_ALL_WITH_HASHID_CHECK))
#define DEM_CFG_ERASE_ALL_DATA_NOT_EQUAL_TO_ERASE_ALL_OFF   (DEM_CFG_ERASE_ALL_DATA_SUPPORTED != DEM_CFG_ERASE_ALL_OFF)

#define DEM_CFG_DEPENDENCY_OFF         STD_OFF
#define DEM_CFG_DEPENDENCY_ON          STD_ON
#define DEM_CFG_DEPENDENCY             DEM_CFG_DEPENDENCY_OFF

#define DEM_CFG_INDICATOR_ON       STD_ON
#define DEM_CFG_INDICATOR_OFF      STD_OFF
#define DEM_CFG_INDICATOR          DEM_CFG_INDICATOR_OFF
