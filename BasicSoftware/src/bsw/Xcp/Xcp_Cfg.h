...
#define XCP_SW_MAJOR_VERSION                      10u
 ...
 */
#define XCP_ENABLE_INTER_MODULE_CHECKS           FALSE
...
#define XCP_ON_CDD_ENABLED                        STD_OFF       /**< Switch to En/Disable the transport layer CDD (XcpOnCdd) */
...
#define XCP_VERSION_ABOVE_1_2                     (((XCP_ASAM_MAJOR_VERSION <= 1u) && (XCP_ASAM_MINOR_VERSION < 3u))  ? STD_OFF : STD_ON)
#define XCP_VERSION_ABOVE_1_3                     (((XCP_ASAM_MAJOR_VERSION <= 1u) && (XCP_ASAM_MINOR_VERSION < 4u))  ? STD_OFF : STD_ON)
...
#define XCP_ODT_DAQ_BUFFER_ELEMENT_SIZE           2u          /**< Factor for the calculation of the DAQ-Queue-Size */
...
#define XCP_DAQ_PACKED_MODE_ENABLED               STD_OFF       /**< DAQ Packed Mode enabled or disabled */
#define XCP_DAQLIST_PROP_PACKEDFLAG               ((uint8)0x10u)/**< Packed flag bit in the DAQ_LIST_PROPERTIES byte in the GET_DAQ_LIST_INFO command response */
#define XCP_SCHEDULECALL_FLAG                     STD_OFF       /**< Schedule call enabled or disabled */
...
#define XCP_RESUME_MODE_FLASH_CHECK               STD_OFF /**< Switch to En/Disable the Software Flash Detect in Resume Mode */ 
#define XCP_STORE_CLEAR_DAQ_SUPPORTED             STD_OFF       /**< Switch to En/Disable the Storing and Clearing of DAQ for Resume mode */
#define XCP_STORE_CAL_SUPPORTED                   STD_OFF       /**< Switch to En/Disable the Storing of Calibration data into memory  */

/* Bypass Mode */
#define XCP_BYPASS_CONSISTENCY                    STD_OFF       /**< Switch to En/Disable the Bypass Consistency */

#if (XCP_BYPASS_CONSISTENCY == STD_ON)
#define XCP_BYPASS_TIMEOUT_THRESHOLD              4u            /** Maximum threshold counter for the timeout event of a bypass event channel */
#endif
...
#define XCP_BUILDCHECKSUM_CMD_TIMEOUT_CNT         198u                                     /**< Macro to specify the timeout for build checksum command */
/***************************************************************************************************
* Type definitions
***************************************************************************************************/
...
typedef struct{
  ...
  /* MR12 DIR 1.1 VIOLATION: Array is not used as flexible array member. The array length is well defined. */
...
typedef struct{
  ...
  uint16  BlockLength_u16;        /**< NvM descriptor block length */
}Xcp_NvMBlockInfo_t;
#endif
...
typedef struct
{
  /* MR12 RULE 1.2 VIOLATION: Array is not used as flexible array member. The array length is well defined. 
                              This violation is raised only when: XCP_COMMANDS_GET_DAQ_INFO == STD_OFF and XCP_STORE_CLEAR_DAQ_SUPPORTED == STD_OFF 
  ...
  /* MR12 RULE 1.2 VIOLATION: Array is not used as flexible array member. The array length is well defined. 
                              This violation is raised only when: XCP_COMMANDS_GET_DAQ_INFO == STD_OFF and XCP_STORE_CLEAR_DAQ_SUPPORTED == STD_OFF and XCP_MAX_DAQRAMSECTIONS == 1 */
...
#if (XCP_BYPASS_CONSISTENCY == STD_ON)
extern Xcp_EventChannel_BypassConsistency_t Xcp_EventChannel_BypassConsistency;
#endif
