...
#define CANTP_IF_PDU_ID_00000     CanIfConf_CanIfTxPduCfg_NPdu_UdsTxPhy_ETAS_CAN_OUT

#define CANTP_IF_FC_PDU_ID_00000  0
#define CANTP_IF_FC_PDU_ID_00001  CanIfConf_CanIfTxPduCfg_NPdu_UdsTxPhy_ETAS_CAN_OUT

/* PduR HandleId import */

#define CANTP_PDUR_DEST_ID_00000  PduRConf_PduRDestPdu_UdsTxPhy_PduR2CanTp_Can_Network_ETAS_Channel_CAN

#define CANTP_PDUR_SRC_ID_00000   PduRConf_PduRSrcPdu_UdsRxFnc_CanTp2PduR_Can_Network_ETAS_Channel_CAN
#define CANTP_PDUR_SRC_ID_00001   PduRConf_PduRSrcPdu_UdsRxPhy_CanTp2PduR_Can_Network_ETAS_Channel_CAN
...
static const struct CanTp_RxSduStructType CanTp_RxSdu[2u] =
		{ { 0xC, 0x0, 0, 1, 0, 0, 0, CANTP_IF_FC_PDU_ID_00000,
				CANTP_PDUR_SRC_ID_00000 }, { 0x8, 0x0, 0, 1, 0, 0, 0,
				CANTP_IF_FC_PDU_ID_00001, CANTP_PDUR_SRC_ID_00001 } };

static const struct CanTp_TimeOutStructType CanTp_TimeOut[2u] = { { 1000, 1000,
		3 }, { 1000, 0, 1000 } };

static const struct CanTp_ParamStructType CanTp_Param[1u] = { { { 0x2, 0x8, },
		0x0 } };
