/*
 * This is SuspendAllInterrupts.c, auto-generated for:
...
/*lint -restore */
OS_VOLATILE VAR(uint32, OS_VAR_CLEARED) Os_SuspendAllCount;
/* [MISRA 2012 Rule 20.1] */ /*lint -save -estring(9019, *) */
...
#include "Os_MemMap.h" /* [MISRA 2012 Dir 4.10] */ /*lint !e537 !e451 */
/*lint -restore */
OS_VOLATILE VAR(Os_imaskType, OS_VAR_NO_INIT) Os_SuspendAllImask;
/* [MISRA 2012 Rule 20.1] */ /*lint -save -estring(9019, *) */
...
FUNC(void, OS_CODE) Os_SuspendAllInterrupts(void) {  /* [$UKS 121] [$UKS 100] [$UKS 1543] */
  if (0U == Os_SuspendAllCount) { /* [$UKS 122] */
    Os_imaskType previous_imask = Os_CurrentImask;
    (void)Os_SetImask(0U); /* [$UKS 123] */ 
    Os_SuspendAllImask = previous_imask;
