/*
 * This is ValidateISR.c, auto-generated for:
...
FUNC(boolean, OS_CODE) Os_IsISRValid(ISRType ISRID)
{
  return (ISRID >= &Os_const_isrs[0]) && (ISRID < &Os_const_isrs[OS_NUM_ISRS]) && ( 0 == ((((Os_BiggestCommonType)ISRID) - ((Os_BiggestCommonType)&Os_const_isrs[0])) % sizeof(Os_ISRType)));
}
/* [MISRA 2012 Rule 20.1] */ /*lint -save -estring(9019, *) */
