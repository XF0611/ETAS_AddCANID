/*
 * This is GetTaskID.c, auto-generated for:
...
FUNC(StatusType, OS_CODE) Os_GetTaskID(TaskRefType TaskID) {
  StatusType api_retval = E_OK; /* [$UKS 86] */
  
   /* [$UKS 807] */
  *TaskID = Os_RunningTask; /* [$UKS 87] [$UKS 88] [$UKS 1536] */
  return api_retval;
} /* GetTaskID */
/* [MISRA 2012 Rule 20.1] */ /*lint -save -estring(9019, *) */
