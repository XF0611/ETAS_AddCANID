/*
 * This is GetStackValue.c, auto-generated for:
...
FUNC(Os_StackValueType, OS_CODE) Os_GetStackValue(void) {
  Os_StackValueType ret; /* [$UKS 1263] */
  ret = Os_GetSP() + Os_GetStackValueAdjust;
  return ret;
} /* GetStackValue */
/* [MISRA 2012 Rule 20.1] */ /*lint -save -estring(9019, *) */
