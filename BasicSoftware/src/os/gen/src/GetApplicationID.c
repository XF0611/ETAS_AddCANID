/*
 * This is GetApplicationID.c, auto-generated for:
...
FUNC(ApplicationType, OS_CODE) Os_GetApplicationID(void) {
  ApplicationType ret; /* [$UKS 417] [$UKS 929] [$UKS 930] */
  ret = (( (INVALID_ISR != Os_RunningISR) ? Os_RunningISR->application : ((INVALID_TASK != Os_RunningTask) ? Os_RunningTask->application : ((INVALID_OSAPPLICATION != Os_AppOverride) ? Os_AppOverride : INVALID_OSAPPLICATION)) ));
  return ret;
} /* GetApplicationID */
/* [MISRA 2012 Rule 20.1] */ /*lint -save -estring(9019, *) */
