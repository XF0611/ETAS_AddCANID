...
// BIP Porting TAO9SGH: When integrating MCAL, if MCAL access this as 32bit wide then alignment error may occur if variables linked to non-32bit alignment address (e.g. IFX TC277D, TC3xx)
#if (FEE_PAGES_USED_BY_BLK_HEADER == 2u)    /* Robust block programming states (Hdpg1 -> Data -> Hdpg2 write) */
