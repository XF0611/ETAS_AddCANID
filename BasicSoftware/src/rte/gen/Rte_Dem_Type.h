...
/* Box: DEM_DTC_ORIGIN_OBD_RELEVANT_MEMORY ("DEM_DTC_ORIGIN_OBD_RELEVANT_MEMORY") begin */
...
/* Box: DEM_DTC_ORIGIN_OBD_RELEVANT_MEMORY ("DEM_DTC_ORIGIN_OBD_RELEVANT_MEMORY") end */
