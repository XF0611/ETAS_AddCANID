...
#elif defined(RTE_RUNNABLEAPI_MainFunction_Can_Network_ETAS_Channel_Can_Network_ETAS)
...
/* Inline read optimization; Rte_Switch_UM_ComMUser_Can_Network_ETAS_Channel_Can_Network_ETAS_currentMode to direct read */
#define Rte_Switch_UM_ComMUser_Can_Network_ETAS_Channel_Can_Network_ETAS_currentMode( data )  ( ((VAR(Std_ReturnType, AUTOMATIC))RTE_E_OK) )
#endif
...
FUNC(Std_ReturnType, ComM_CODE) ComM_GetInhibitionStatus(VAR(NetworkHandleType, AUTOMATIC) Channel,
                                                         P2VAR(ComM_InhibitionStatusType, AUTOMATIC, RTE_APPL_DATA) Status);
...
FUNC(Std_ReturnType, ComM_CODE) ComM_ReadInhibitCounter(P2VAR(uint16, AUTOMATIC, RTE_APPL_DATA) CounterValue);
