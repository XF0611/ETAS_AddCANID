...
/* 10 memory */
#define BB_MEM_MAX_NUM 9  /* Max mem number */
#define BB_MEM_ACT_DML 9  /* DML d,k list */
#define BB_MEM_ACT_ANC 8  /* DE-AMBILITY Parameters */
#define BB_MEM_ACT_RLT 7
#define BB_MEM_ACT_MAC 6
#define BB_MEM_ACT_COE 5
#define BB_MEM_ACT_BUF 4
#define BB_MEM_ACT_NVE 3
#define BB_MEM_ACT_WIN 2
#define BB_MEM_ACT_SAM 1
