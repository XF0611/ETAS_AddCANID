...
**                      Include Section                                       **
*******************************************************************************/
#include "Os_Compiler_Cfg.h"       /* Compiler specific attribute for OS      */
#include "Bsw_Compiler_Cfg.h"      /* Compiler specific attribute for RTA-BSW */

#define AUTOSAR_431 /* Definition used for OS generation inclusing of Compiler_Cfg.h. */
