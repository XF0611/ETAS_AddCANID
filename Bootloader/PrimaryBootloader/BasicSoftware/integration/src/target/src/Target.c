...
void Target_EnableInterrupts(void)
{
    ...
    dmu_irq_enable(39 /*IRQ_CAN0_INTERRUPT0*/,1);
    dmu_irq_enable(40 /*IRQ_CAN0_INTERRUPT1*/,1);
    dmu_irq_enable(41 /*IRQ_CAN0_INTERRUPT2*/,1);
    dmu_irq_enable(42 /*IRQ_CAN0_INTERRUPT3*/,1);
}
