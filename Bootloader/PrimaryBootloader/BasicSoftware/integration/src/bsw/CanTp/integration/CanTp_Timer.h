...
LOCAL_INLINE void CanTp_GetElapsedValue(TickType *Value, TickType *ElapsedValue)
{
    ...
    (void)GetElapsedValue(Millisecond_TickCounter, Value, ElapsedValue); /* Project has to debug for any error hook calls and GetElapsedValue Api returning E_NOT_OK. */
