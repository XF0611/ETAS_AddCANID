...
/* MR12 RULE 20.5 VIOLATION: AUTOSAR MemMap concept requires #undef,
    ...
    #if defined DCM_WAS_STARTED_SEC_CODE
		#error DCM_WAS_STARTED_SEC_CODE already defined
	#endif
	...
	#define DCM_WAS_STARTED_SEC_CODE
#elif defined(DCM_STOP_SEC_CODE)
    #if ! defined DCM_WAS_STARTED_SEC_CODE
		#error DCM_STOP_SEC_CODE without START_SEC
	#else
		#undef DCM_WAS_STARTED_SEC_CODE
	#endif
