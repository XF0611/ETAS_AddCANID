...
//ETAS BIP Porting TODO #include "Rtm.h"
...
# if (RTM_NUM_CORES > 1)
     ...
     */
    //ETAS BIP Porting TODO task->dynamic->last_activation = Os_Cbk_GetStopwatch();
#endif
}
#define OS_STOP_SEC_CALLOUT_CODE
#include "Os_MemMap.h"
...
{
    //ETAS BIP Porting TODO Rtm_TaskEnd(task);
}
#define OS_STOP_SEC_CALLOUT_CODE                   
#include "Os_MemMap.h"
...
{
    //ETAS BIP Porting TODO Rtm_IsrEnd(isr);
}
#define OS_STOP_SEC_CALLOUT_CODE
#include "Os_MemMap.h"
