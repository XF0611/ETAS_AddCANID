...
#define CAN_MAIN_FUNCTION_WRITE_POLLING_ALLOWED  (STD_OFF)


#define CAN_MAIN_FUNCTION_READ_POLLING_ALLOWED   (STD_OFF)
...
#define CAN_NUM_OF_HRHS 		 (2U)

/* Total Number Of HTH Configured*/
#define CAN_NUM_OF_HTHS  		 (1U)
...
#define CanConf_CanHardwareObject_CANNODE_0_Rx_Std_MailBox_1      0         
#define CanConf_CanHardwareObject_CANNODE_0_Rx_Std_MailBox_2      1         
#define CanConf_CanHardwareObject_CANNODE_0_Tx_Std_MailBox_1      2         
...
/* CAN ID index array number */#define CANID_STD_NUM 				3U
