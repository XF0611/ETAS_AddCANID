...
#define OS_NUM_TASKS (21U)
#define OS_NUM_ISRS (6U)
...
extern FUNC(void, OS_CODE) Os_Entry_osTask_1ms(void);
extern FUNC(void, OS_CODE) Os_Entry_osTask_5ms(void);
extern FUNC(void, OS_CODE) Os_Entry_osTask_10ms(void);
extern FUNC(void, OS_CODE) Os_Entry_osTask_20ms(void);
extern FUNC(void, OS_CODE) Os_Entry_osTask_StartUp(void);
extern FUNC(void, OS_CODE) Os_Entry_osTask_15ms(void);
