/*
 * This is GetStackSize.c, auto-generated for:
...
FUNC(Os_StackSizeType, OS_CODE) Os_GetStackSize(Os_StackValueType Base, Os_StackValueType Sample) {
  Os_StackSizeType ret;  /* [$UKS 1264] */
  ret = Base - Sample;
  return ret;
} /* GetStackSize */
/* [MISRA 2012 Rule 20.1] */ /*lint -save -estring(9019, *) */
