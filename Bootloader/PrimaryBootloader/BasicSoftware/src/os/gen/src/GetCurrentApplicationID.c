/*
 * This is GetCurrentApplicationID.c, auto-generated for:
...
FUNC(ApplicationType, OS_CODE) Os_GetCurrentApplicationID(void) {
  ApplicationType ret; /* [$UKS 2004] [$UKS 2005] [$UKS 2006] */
  ret = (( (INVALID_OSAPPLICATION != Os_AppOverride) ? Os_AppOverride : ((INVALID_ISR != Os_RunningISR) ? Os_RunningISR->application : ((INVALID_TASK != Os_RunningTask) ? Os_RunningTask->application : INVALID_OSAPPLICATION) )));
  return ret;
