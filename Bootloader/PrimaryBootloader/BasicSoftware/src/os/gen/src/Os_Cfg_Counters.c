...
CONST(Os_ScheduleTableType, OS_CONST_FAST) Os_const_scheduletables[OS_NUM_SCHEDULETABLES] = {
  { &Os_dyn_scheduletables[0], &Os_const_counters[0],
    TRUE,
  ...
  { &Os_dyn_scheduletables[1], &Os_const_counters[1],
    TRUE,
...
CONST(uint8, OS_CONST) Os_const_expiry_intervals[] = {
  1U,1U,1U,1U,1U,1U,1U,1U,1U,1U,1U,1U,1U,1U,1U,1U,1U,1U,1U,1U,2U,
...
CONST(uint8, OS_CONST) Os_const_expiry_actions[] = {
  /* Fbl_ScheduleTable */
  33U, 32U, 39U, 33U, 33U, 34U, 33U, 33U, 33U, 33U, 33U, 32U, 35U, 32U, 37U, 33U, 33U, 33U, 32U, 35U, 32U, 43U, 33U, 33U, 33U, 32U, 35U, 32U, 36U, 1U,
  /* Rte_ScheduleTable */
...
FUNC(StatusType, OS_CODE) Os_IncrementCounter_Rte_TickCounter(void) {
  ...
  { /* [$UKS 304] [$UKS 306] [$UKS 307] [$UKS 910] */
  Os_ScheduleTableDynType *current_std = &Os_dyn_scheduletables[1];
  ScheduleTableType current_stc = &Os_const_scheduletables[1];
  while (current_std < &Os_dyn_scheduletables[2]) { /*lint !e946 pointer does reference the same array */
    if ((current_std->state == SCHEDULETABLE_RUNNING) && (now == current_std->match)) {
      (void)Os_PerformEP(current_stc, current_std, (TickType)(65536U));
    }
    current_std++;
...
{ /* [$UKS 1566]  [$UKS 1567] */
  ...
  for(;;) { /*lint !e716 */
    cfg_index = (((*current_action & 62U) >> 1U)); /* [MISRA 2012 Rule 10.6] */ /*lint !e9031 !e9034 */
