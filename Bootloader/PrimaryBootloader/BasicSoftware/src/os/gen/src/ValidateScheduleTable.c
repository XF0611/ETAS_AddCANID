/*
 * This is ValidateScheduleTable.c, auto-generated for:
...
FUNC(boolean, OS_CODE) Os_IsScheduleTableValid(ScheduleTableType ScheduleTableID)
{
  return (ScheduleTableID >= &Os_const_scheduletables[0]) && (ScheduleTableID < &Os_const_scheduletables[OS_NUM_SCHEDULETABLES]) && ( 0 == ((((Os_BiggestCommonType)ScheduleTableID) - ((Os_BiggestCommonType)&Os_const_scheduletables[0])) % sizeof(Os_ScheduleTableType)));
}
/* [MISRA 2012 Rule 20.1] */ /*lint -save -estring(9019, *) */
