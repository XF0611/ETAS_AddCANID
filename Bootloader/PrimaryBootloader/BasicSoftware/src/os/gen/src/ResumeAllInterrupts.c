/*
 * This is ResumeAllInterrupts.c, auto-generated for:
...
FUNC(void, OS_CODE) Os_ResumeAllInterrupts(void) { /* [$UKS 116] [$UKS 117] [$UKS 120] [$UKS 119] [$UKS 100] [$UKS 1544] */
  /* Assumed to be entered with all interrupts disabled */
  
  if (Os_SuspendAllCount != 0U) { /* [$UKS 813] */
    if (0U == --Os_SuspendAllCount) { 
        
      (void)Os_SetImask(Os_SuspendAllImask);
    }
  }
  return;
} /* ResumeAllInterrupts */
