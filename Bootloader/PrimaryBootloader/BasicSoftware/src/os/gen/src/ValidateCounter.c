/*
 * This is ValidateCounter.c, auto-generated for:
...
FUNC(boolean, OS_CODE) Os_IsCounterValid(CounterType CounterID)
{
  return (CounterID >= &Os_const_counters[0]) && (CounterID < &Os_const_counters[OS_NUM_COUNTERS]) && ( 0 == ((((Os_BiggestCommonType)CounterID) - ((Os_BiggestCommonType)&Os_const_counters[0])) % sizeof(Os_CounterType)));
}
/* [MISRA 2012 Rule 20.1] */ /*lint -save -estring(9019, *) */
