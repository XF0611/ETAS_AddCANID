...
#include "Os_MemMap.h" /* [MISRA 2012 Dir 4.10] */ /*lint !e537 !e451 */
/*lint -restore */
extern FUNC(void, OS_CODE) Os_Entry_Can0_InterruptHandler_0(void);
/* [MISRA 2012 Rule 20.1] */ /*lint -save -estring(9019, *) */
#define OS_STOP_SEC_CODE
#include "Os_MemMap.h" /* [MISRA 2012 Dir 4.10] */ /*lint !e537 !e451 */
/*lint -restore */
...
#include "Os_MemMap.h" /* [MISRA 2012 Dir 4.10] */ /*lint !e537 !e451 */
/*lint -restore */
extern FUNC(void, OS_CODE) Os_Entry_Can0_InterruptHandler_1(void);
/* [MISRA 2012 Rule 20.1] */ /*lint -save -estring(9019, *) */
#define OS_STOP_SEC_CODE
#include "Os_MemMap.h" /* [MISRA 2012 Dir 4.10] */ /*lint !e537 !e451 */
/*lint -restore */
...
#include "Os_MemMap.h" /* [MISRA 2012 Dir 4.10] */ /*lint !e537 !e451 */
/*lint -restore */
extern FUNC(void, OS_CODE) Os_Entry_Can0_InterruptHandler_2(void);
/* [MISRA 2012 Rule 20.1] */ /*lint -save -estring(9019, *) */
#define OS_STOP_SEC_CODE
#include "Os_MemMap.h" /* [MISRA 2012 Dir 4.10] */ /*lint !e537 !e451 */
/*lint -restore */
...
#include "Os_MemMap.h" /* [MISRA 2012 Dir 4.10] */ /*lint !e537 !e451 */
/*lint -restore */
extern FUNC(void, OS_CODE) Os_Entry_Can0_InterruptHandler_3(void);
/* [MISRA 2012 Rule 20.1] */ /*lint -save -estring(9019, *) */
#define OS_STOP_SEC_CODE
#include "Os_MemMap.h" /* [MISRA 2012 Dir 4.10] */ /*lint !e537 !e451 */
/*lint -restore */
...
FUNC(void, OS_CODE) Os_InitializeVectorTable(void) {
  ...
  //ETAS BIP Porting TODO to change to configurable.
  arc_int_disable(39 /*IRQ_CAN0_INTERRUPT0*/);
  int_handler_install(39 /*IRQ_CAN0_INTERRUPT0*/, Os_Entry_Can0_InterruptHandler_0);
  arc_int_enable(39 /*IRQ_CAN0_INTERRUPT0*/);

  //ETAS BIP Porting TODO to change to configurable.
  arc_int_disable(40 /*IRQ_CAN0_INTERRUPT1*/);
  int_handler_install(40 /*IRQ_CAN0_INTERRUPT1*/, Os_Entry_Can0_InterruptHandler_1);
  arc_int_enable(40 /*IRQ_CAN0_INTERRUPT1*/);

  //ETAS BIP Porting TODO to change to configurable.
  arc_int_disable(41 /*IRQ_CAN0_INTERRUPT2*/);
  int_handler_install(41 /*IRQ_CAN0_INTERRUPT2*/, Os_Entry_Can0_InterruptHandler_2);
  arc_int_enable(41 /*IRQ_CAN0_INTERRUPT2*/);

  //ETAS BIP Porting TODO to change to configurable.
  arc_int_disable(42 /*IRQ_CAN0_INTERRUPT3*/);
  int_handler_install(42 /*IRQ_CAN0_INTERRUPT3*/, Os_Entry_Can0_InterruptHandler_3);
  arc_int_enable(42 /*IRQ_CAN0_INTERRUPT3*/);
