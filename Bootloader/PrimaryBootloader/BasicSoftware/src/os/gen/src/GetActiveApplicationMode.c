/*
 * This is GetActiveApplicationMode.c, auto-generated for:
...
FUNC(AppModeType, OS_CODE) Os_GetActiveApplicationMode(void) {
  AppModeType ret; /* [$UKS 384] */
  ret = Os_CurrentAppMode;
  return ret;
