...
void CanTp_Init(const CanTp_ConfigType *CfgPtr)
{
    ...
    {   /* TRACE[SWS_CanTp_00030][SWS_CanTp_00111][SWS_CanTp_00273] */
		...
		CanTp_Prv_TxConfirmation_ArrayInit(&CanTp_TxConfirmationChannel[0], CanTp_CfgPtr->NumberOfTxPdus, CANTP_INVALID_CHANNEL);
		...
		switch(SubState)
		{
            ...
            case CANTP_TX_WAIT_FOR_TRANSMIT_CONFIRMATION:
                ...
                Channel->SduLengthRemaining = (Channel->SduLengthRemaining < MaxCopyLength) ? 0u :
                                              (PduLengthType)((Channel->SduLengthRemaining - MaxCopyLength));
