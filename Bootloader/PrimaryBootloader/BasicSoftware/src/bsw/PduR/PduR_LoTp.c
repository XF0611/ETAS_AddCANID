 ...
 **************************************************************************************************
 */
void PduR_CanTpTxConfirmation(PduIdType id, Std_ReturnType std) {
 ...
 *                  PduInfoType * ptr            :Pointer to the buffer (SduDataPtr) and its length
...
BufReq_ReturnType PduR_CanTpStartOfReception(PduIdType id,
		...
		PduLengthType *bufferSizePtr) {
	return (PduR_rCanTpStartOfReception((id), (info), (TpSduLength),
			(bufferSizePtr)));
}
