...
#define     DCM_CFG_DET_SUPPORT_ENABLED             DCM_CFG_OFF
#define     DCM_CFG_TASK_TIME_US                    5000u              /* DCM task time in Micro sec */
#define     DCM_CFG_TASK_TIME_MS                    5u             /* DCM task time in Milli sec */
...
#define     DCM_CFG_RTESUPPORT_ENABLED              DCM_CFG_OFF         /* RTE Support within Dcm disabled */
...
#define     DCM_CALLAPPLICATIONONREQRX_ENABLED            DCM_CFG_ON          /* Calling the application while receiving the request in Dcm is enabled */
...
#define     DCM_CFG_MAX_WAITPEND                    30u                 /* Max. no. of Wait Pend that can be sent before sending a General Reject NRC */
...
#ifndef DcmConf_DcmDspSecurityRow_DSP_SEC_FBL
#define DcmConf_DcmDspSecurityRow_DSP_SEC_FBL        0x9
#endif
...
#define     DCM_CFG_OSTIMER_USE                     TRUE

#define     DCM_CFG_TICKS2US_COUNTER                OS_GET_SYSTEM_COUNTER_US
#define     DCM_CFG_COUNTERID                       1
...
#ifdef DcmConf_DcmDslProtocolRx_UDS_Rx_Phys_Id_0x737_CANNODE_0_PduR2Dcm
...
#else
#define DcmConf_DcmDslProtocolRx_UDS_Rx_Phys_Id_0x737_CANNODE_0_PduR2Dcm       0x0      /*Rx PDU ID*/
#endif
#ifdef DcmConf_DcmDslProtocolRx_UDS_Rx_Func_Id_0x7DF_CANNODE_0_PduR2Dcm
#error "Symbolic names generated for DcmDslProtocolRxPduId is incorrect as the short names of configured DcmDslProtocolRx in not unique, Run Generate Id and Config Code generation once again."
#else
#define DcmConf_DcmDslProtocolRx_UDS_Rx_Func_Id_0x7DF_CANNODE_0_PduR2Dcm       0x1      /*Rx PDU ID*/
#endif

/* Symbolic Name generation for TxConfirmtionPduId */

#ifdef DcmConf_DcmDslProtocolTx_UDS_Tx_Phys_Id_0x7B7_CANNODE_0_Phys_Dcm2PduR
...
#else
#define DcmConf_DcmDslProtocolTx_UDS_Tx_Phys_Id_0x7B7_CANNODE_0_Phys_Dcm2PduR         0x0       /*Tx Confirmation PDU ID*/
#endif
...
#define     DCM_CFG_DSL_BUFFER__DCMDSLBUFFER_UDS_TX 1026   /* Buffer Size */
#define     DCM_CFG_DSL_BUFFER__DCMDSLBUFFER_UDS_RX 2050   /* Buffer Size */
