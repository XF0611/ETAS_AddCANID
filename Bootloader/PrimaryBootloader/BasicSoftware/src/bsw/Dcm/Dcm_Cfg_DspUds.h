...
#define DCM_CFG_DSP_CLEARDIAGNOSTICINFORMATION_ENABLED      DCM_CFG_OFF /* CDI service disabled */
#define DCM_CFG_DSP_ROUTINECONTROL_ENABLED                  DCM_CFG_ON  /* Routine control service enabled */
#define DCM_CFG_DSP_IOCBI_ENABLED                           DCM_CFG_OFF /* IOCBI service is disabled */
...
/* DID with DefaultUsePort and  new SenderReceiver interface enabled */

    #define DCM_CFG_DSP_READ_NEW_SR_INTERFACE_ENABLED     DCM_CFG_OFF  /*Read DID with Default DIDUsePort   */
...
/* DID with DefaultUsePort and new SenderReceiver interface enabled */
    ...
    #define DCM_CFG_DSP_WRITE_NEW_SR_INTERFACE_ENABLED     DCM_CFG_OFF  /*Write DID with Default DIDUsePort  */


/* TransferData Service Configurtion */
#define DCM_CFG_DSP_TRANSFERDATA_ENABLED           DCM_CFG_ON  /* TransferData service is enabled */
...
#define DCM_CFG_DSP_IOCBI_ASP_ENABLED        DCM_CFG_OFF  /* IOCBI service is not Configured  */
...
#define DCM_CFG_DSP_WRITE_ASYNCH_FNC_ENABLED       DCM_CFG_ON  /* The signal of the DID in WDBI Service has useport configured as USE_DATA_ASYNCH_FNC */
...
#define DCM_CFG_DSP_REQUESTDOWNLOAD_ENABLED                   DCM_CFG_ON  /* RequestDownload service is enabled */
#define DCM_CFG_DSP_REQUESTTRANSFEREXIT_ENABLED             DCM_CFG_ON  /* RequestTransferExit service is enabled */
...
#define DCM_CFG_DSP_READDTCINFORMATION_ENABLED              DCM_CFG_OFF  /* State of RDTC Service, Enabled or Disabled? */

#define DCM_CFG_DSP_RDTCSUBFUNC_0x01_ENABLED                DCM_CFG_OFF  /* RDTC Subfunction 0x01 Enabled or Disabled? */
#define DCM_CFG_DSP_RDTCSUBFUNC_0x02_ENABLED                DCM_CFG_OFF  /* RDTC Subfunction 0x02 Enabled or Disabled? */
#define DCM_CFG_DSP_RDTCSUBFUNC_0x03_ENABLED                DCM_CFG_OFF  /* RDTC Subfunction 0x03 Enabled or Disabled? */
#define DCM_CFG_DSP_RDTCSUBFUNC_0x04_ENABLED                DCM_CFG_OFF  /* RDTC Subfunction 0x04 Enabled or Disabled? */
#define DCM_CFG_DSP_RDTCSUBFUNC_0x05_ENABLED                DCM_CFG_OFF  /* RDTC Subfunction 0x05 Enabled or Disabled? */
#define DCM_CFG_DSP_RDTCSUBFUNC_0x06_ENABLED                DCM_CFG_OFF  /* RDTC Subfunction 0x06 Enabled or Disabled? */
...
#define DCM_CFG_DSP_RDTCSUBFUNC_0x0A_ENABLED                DCM_CFG_OFF  /* RDTC Subfunction 0x0A Enabled or Disabled? */
...
#define DCM_CFG_NUMRDTCSUBFUNC         0u           /* Number of subfunctions configured for Read DTC Info service */
...
#ifndef DSP_SEC_FBL
#define DSP_SEC_FBL        0x9          /* Symbolic values for Security */
#endif
...
#define DCM_CFG_DSP_SECA_USEFLEXIBLELENGTH  DCM_CFG_OFF 
...
#define DCM_CFG_DSP_NUMRESETTYPE    1u  /* Number of Reset Types configured */
...
#define DCM_CFG_RC_NUMRIDS  4u          /* Number of Routine Identifiers Configured */
...
#define DCM_CFG_DSP_ALLSIGNAL_OPAQUE      DCM_CFG_ON


/* RDBI USE DATA PORT CONFIGURATION */
#define DCM_CFG_DSP_READ_SYNCH_FNC_ENABLED                           DCM_CFG_OFF /* DID with signals of use port type USE_DATA_SYNCH_FNC or USE_DATA_SYNCH_CLIENT_SERVER is Enabled or Disabled?*/

#define DCM_CFG_DSP_READ_ASYNCH_FNC_ENABLED                           DCM_CFG_ON  /* DID with signals of use port type USE_DATA_ASYNCH_FNC or USE_DATA_ASYNCH_CLIENT_SERVER is Enabled or Disabled?*/
...
#define DCM_CFG_DSP_ALLSIGNAL_FIXED_LENGTH       DCM_CFG_ON
...
#define DCM_CFG_RMBAPAGESIZE           8           /* Default Page Size to be requested in one request */
...
/***********DataInterface Type (DataUseports) is configured as CLIENT or SENDER_RECEIVER for DIDs*********/
#define DCM_CFG_DSP_DIDDATA_CS_OR_SR_ENABLED          DCM_CFG_OFF
...
/***********Macro to indicate if the page buffer support for RMBA sevice is enabled or not*********/
#define DCM_CFG_RMBAPAGEDBUFFERSUPPORT      DCM_CFG_OFF     /* Paged buffer support for RMBA service is disabled */
...
#define DCM_CFG_DSP_RDTCEXTENDEDDATA_OR_FREEZEFRAME_SUBFUNC_ENABLED      DCM_CFG_OFF     /* Paged buffer support for RDTC service is disabled */

#define DCM_CFG_DSP_REPORTDTC_OR_MIRRORMEMORYDTC_OR_USERDEFINEDDTC_EXTENDEDDATARECORDBYDTCNUMBER       DCM_CFG_OFF

#define DCM_CFG_DSP_REPORTDTC_OR_USERDEFINEDMEMORYDTC_SNAPSHOTRECORDBYDTCNUMBER     DCM_CFG_OFF
...
#define DCM_CFG_DSP_REQUESTDOWNLOAD_SEQUENCECHECK_ENABLED     DCM_CFG_ON   /* Sequence check for RequestDownload service is enabled */
...
#define DCM_CFG_DSP_FLEXIBLEDATA_ENABLED     DCM_CFG_ON   /* Flexible data length check for TransferData Request/Response enabled */
...
#define DCM_CFG_NUM_SUB_NODES                    0x00        /*Number of sub nodes configured*/
...
#define DCM_CFG_DSP_BSWMDCM_ENABLED    DCM_CFG_OFF   /*  In the BswM module check if Dcm is enabled */
/* Communication Control - End */

/* Control DTC Setting Service Configuration Start */


#define DCM_CFG_DSP_CDTCMODECHECK       DCM_CFG_ON /* Reenable cdtc by mode rule check*/
...
#define DCM_CFG_VIN_SUPPORTED                           DCM_CFG_ON    /* reading the VIN DID is supported */
#define DCM_CFG_VIN_DID                                 0xF190      /* Identifier of VIN DID */
...
#endif
#ifndef     DCM_RMBAPAGESIZE
#define     DCM_RMBAPAGESIZE                            DCM_CFG_RMBAPAGESIZE
#endif
