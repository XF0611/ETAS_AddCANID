 ...
 * Type:            EcucBooleanParamDef
 ******************************************************************************************************************** */
#define FEE_RB_ACT_UNKNOWN_BLOCK_REORG   TRUE
 ...
 * Type:            EcucBooleanParamDef
 ******************************************************************************************************************** */
#define FEE_RB_ACT_UNKNOWN_BLOCK_CACHE_SIZE   1800u
...
#define FEE_REQUIRED_FREE_SPACE_BEFORE_SOFT_SR        32776uL  /* FEE_REQUIRED_FREE_SPACE_BEFORE_HARD_SR = Min sector size + 1 = 32768 byte + 1) * 1,5 */
#define FEE_REQUIRED_FREE_SPACE_BEFORE_HARD_SR        32776uL  /* FEE_REQUIRED_FREE_SPACE_BEFORE_HARD_SR = Min sector size + 1 = 32768 byte + 1 */
...
#define FEE_RB_ACT_UNKNOWN_BLK_CACHE_ARRAY_SIZE     300u
...
#define FeeConf_FeeBlockConfiguration_NV_BootSoftwareFingerprintBlock                             0
#define FeeConf_FeeBlockConfiguration_NV_PBLValidFlagBlock                                        1
#define FeeConf_FeeBlockConfiguration_NV_ApplicationValidFlagBlock                                2
#define FeeConf_FeeBlockConfiguration_NV_ApplicationDataFingerprintBlock                          3
#define FeeConf_FeeBlockConfiguration_NV_ApplicationSoftwareFingerprintBlock                      4
#define FeeConf_FeeBlockConfiguration_NV_PreErasedBlock                                           5
#define FeeConf_FeeBlockConfiguration_NV_ExternalReprogrammingRequestFlagBlock                    6
