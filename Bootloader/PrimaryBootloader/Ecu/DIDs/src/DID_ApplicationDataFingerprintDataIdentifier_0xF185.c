...
*********************************************************************************************************************/
Std_ReturnType DID_ApplicationDataFingerprintDataIdentifier_0xF185_ReadFunc (Dcm_OpStatusType OpStatus,uint8 * Data)                       /* PRQA S 3206, 1503 */
{
    Std_ReturnType retVal = E_NOT_OK;
    retVal = DIDService_ReadFingerPrintInfor(ApplicationDataFingerprint,Data);
    return retVal;
}

FUNC(Std_ReturnType,DCM_APPL_CODE) DID_ApplicationDataFingerprintDataIdentifier_0xF185_WriteFunc (P2CONST(uint8,AUTOMATIC,DCM_INTERN_DATA) Data,     /* PRQA S 3206, 1503, 3408 */        
                                                                    ...
                                                                    AUTOMATIC,DCM_INTERN_DATA) ErrorCode)
{
    ...
    *ErrorCode = DCM_E_INCORRECTMESSAGELENGTHORINVALIDFORMAT;
    ...
    if(retVal == E_OK)
    {
      retVal = DIDService_WriteFingerprint(ApplicationDataFingerprint,Data);
    }
