...
/**
 * @brief ETAS BIP Porting: as these value are not generated from configuraiton, ETAS change them for SBL use.
 */
#define FlsBaseAddress   0x00000U         //Flash base address
#define FLS_ENDADDRESS   0x3FFFFFU	      //Flash end address
